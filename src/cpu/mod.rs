...
#[allow(dead_code)] pub const REGISTER_RAX: usize = 0;
#[allow(dead_code)] pub const REGISTER_RCX: usize = 1;
#[allow(dead_code)] pub const REGISTER_RDX: usize = 2;
#[allow(dead_code)] pub const REGISTER_RBX: usize = 3;
#[allow(dead_code)] pub const REGISTER_RSP: usize = 4;
#[allow(dead_code)] pub const REGISTER_RBP: usize = 5;
#[allow(dead_code)] pub const REGISTER_RSI: usize = 6;
#[allow(dead_code)] pub const REGISTER_RDI: usize = 7;

#[allow(dead_code)] pub const REGISTER_R8: usize = 8;
#[allow(dead_code)] pub const REGISTER_R9: usize = 9;
#[allow(dead_code)] pub const REGISTER_R10: usize = 10;
#[allow(dead_code)] pub const REGISTER_R11: usize = 11;
#[allow(dead_code)] pub const REGISTER_R12: usize = 12;
#[allow(dead_code)] pub const REGISTER_R13: usize = 13;
#[allow(dead_code)] pub const REGISTER_R14: usize = 14;
#[allow(dead_code)] pub const REGISTER_R15: usize = 15;
...
const OPERATOR_TYPE_REG_32_64: LazyLock<OperatorType> = LazyLock::new(|| OperatorType::Reg32 | OperatorType::Reg64);
const OPERATOR_TYPE_REG_16_32_64: LazyLock<OperatorType> = LazyLock::new(|| OperatorType::Reg16 | OperatorType::Reg32 | OperatorType::Reg64);

const OPERATOR_TYPE_IMM_32_64: LazyLock<OperatorType> = LazyLock::new(|| OperatorType::CanImmediate32 | OperatorType::CanImmediate64);
const OPERATOR_TYPE_IMM_16_32_64: LazyLock<OperatorType> = LazyLock::new(|| OperatorType::CanImmediate16 | OperatorType::CanImmediate32 | OperatorType::CanImmediate64);

const OPERATOR_TYPE_REG_ECX_REX: LazyLock<OperatorType> = LazyLock::new(|| OperatorType::EAX | OperatorType::RAX);
const OPERATOR_TYPE_REG_AX_ECX_REX: LazyLock<OperatorType> = LazyLock::new(|| OperatorType::AX | OperatorType::EAX | OperatorType::RAX);
...
struct Sib {
    #[allow(dead_code)] pub scale: u8,
    #[allow(dead_code)] pub index: u8,
    pub base: u8
}
...
impl Cpu {
    ...
    fn add_opcode(&mut self, opcode: Opcode, code: u8, target_info: OperatorType, source_info: OperatorType) {
        self.add_opcode_format(opcode, code, false, target_info, source_info, false)
    }

    fn add_8bit_opcode(&mut self, opcode: Opcode, code: u8, target_info: OperatorType, source_info: OperatorType) {
    ...
    fn add_opcode_format(&mut self, opcode: Opcode, code: u8, contain_reg: bool, target_info: OperatorType, source_info: OperatorType, _is8bit: bool) {
        if contain_reg  {
            self.opcode_formats.insert(code    , OpcodeFormat { opcode, target_info, source_info, _is8bit });
            self.opcode_formats.insert(code + 1, OpcodeFormat { opcode, target_info, source_info, _is8bit });
            self.opcode_formats.insert(code + 2, OpcodeFormat { opcode, target_info, source_info, _is8bit });
            self.opcode_formats.insert(code + 3, OpcodeFormat { opcode, target_info, source_info, _is8bit });
            self.opcode_formats.insert(code + 4, OpcodeFormat { opcode, target_info, source_info, _is8bit });
            self.opcode_formats.insert(code + 5, OpcodeFormat { opcode, target_info, source_info, _is8bit });
            self.opcode_formats.insert(code + 6, OpcodeFormat { opcode, target_info, source_info, _is8bit });
            self.opcode_formats.insert(code + 7, OpcodeFormat { opcode, target_info, source_info, _is8bit });
    ...
    fn process(&mut self, byte: u8) -> Opcode {
        ...
        let bit_mode = if _is8bit { RegisterType::_8Bit }
            else if self.operand_16bit { RegisterType::_16Bit }
            else if self.rex_w { RegisterType::_64Bit }
            else { RegisterType::_32Bit };

        if target_info.intersects(
            OperatorType::FromModrmRM.or(OperatorType::FromModrmREG)) ||
